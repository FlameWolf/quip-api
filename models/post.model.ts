...
import { getUnicodeClusterCount, maxContentLength, maxPollOptionLength, minPollDuration, maxPollDuration, maxMediaDescriptionLength } from "../library.ts";
			...
			mediaFile: new Schema({
				...
				description: {
					...
					validate: {
						...
						message: "Media description length exceeds the maximum allowed limit"
					}
				}
			}),
