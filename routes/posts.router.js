...
router.post("/create", authenticateRequest, multerController.uploadMediaFile, postsController.createPost);
...
router.post("/quote/:postId", authenticateRequest, multerController.uploadMediaFile, postsController.quotePost);
...
router.post("/reply/:postId", authenticateRequest, multerController.uploadMediaFile, postsController.replyToPost);
