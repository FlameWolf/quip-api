...
router.post("/create", requireAuthentication, multerController.uploadMediaFile, postsController.createPost);
...
router.post("/quote/:postId", requireAuthentication, multerController.uploadMediaFile, postsController.quotePost);
...
router.post("/reply/:postId", requireAuthentication, multerController.uploadMediaFile, postsController.replyToPost);
