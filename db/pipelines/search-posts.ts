...
const getPageConditions = (sortByDate: boolean, idCompare: string, lastScore?: string, lastPostId?: string | ObjectId): Filter<any> => {
...
const searchPostsAggregationPipeline = (searchText: string = emptyString, searchOptions: Dictionary = {}, sortBy: string = "match", dateOrder: string = "desc", userId?: string | ObjectId, lastScore?: string, lastPostId?: string | ObjectId): Array<PipelineStage> => {
